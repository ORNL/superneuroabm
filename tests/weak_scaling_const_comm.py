...
def main():
    ...
    if rank == 0:
        print("="*70)
        print(f"WEAK SCALING TEST - Constant Communication Model")
        print("="*70)
        print(f"Goal: Show that more workers enable LARGER networks")
        print(f"      with CONSTANT cross-worker communication overhead")
        print("="*70)
    ...
    network_filename = (
        ...
        f"intra{intra_cluster_prob}_cross{cross_cluster_edges}_s42.pkl"
    )
