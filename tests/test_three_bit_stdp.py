...
class TestThreeBitSTDP(unittest.TestCase):
    ...
    def test_single_spike_response(self):
        ...
        vizualize_responses(model, vthr=10, fig_name=f"{caller_name}_three_bit_stdp.png")
    ...
    def test_weight_is_quantized(self):
        ...
        # Check the weight is one of the valid quantization levels
