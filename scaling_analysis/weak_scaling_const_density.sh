#!/bin/bash
#SBATCH -A lrn088
#SBATCH -J weak_scaling_constdensity
#SBATCH -o /lustre/orion/lrn088/proj-shared/objective3/xxz/superneuroabm/tests/output/weak_scaling_constdensity_%j.out
#SBATCH -t 01:00:00
#SBATCH -p batch
#SBATCH -q debug
#SBATCH -N 1
...
# Weak scaling test on Frontier - CONSTANT DENSITY MODEL
# Inter-cluster probability remains constant as network scales
# Uses weak_scaling_const_density.py
...
echo "======================================================================"
echo "Weak Scaling Test - Constant Density Model"
echo "======================================================================"
echo "Goal: Demonstrate that MORE WORKERS enable LARGER NETWORKS"
echo "      with CONSTANT inter-cluster connection probability"
echo "======================================================================"
...
for NWORKERS in 2 4; do
    ...
    srun -n$NWORKERS -c7 --gpus-per-task=1 --gpu-bind=closest \
        python weak_scaling_const_density.py \
