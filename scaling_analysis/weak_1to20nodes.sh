...
echo "======================================================================"
echo "Weak Scaling Test (Brunel) - 1 to 20 Nodes Sequential"
echo "======================================================================"
...
for IN_DEGREE in "${IN_DEGREE_ARRAY[@]}"; do
    ...
    for NNODES in {1..20}; do
        ...
        echo ""
        echo "======================================================================"
        echo "Testing: $NNODES nodes, $NWORKERS GPUs, $TOTAL_NEURONS neurons | K: $IN_DEGREE"
        echo "======================================================================"
        ...
        if [ $EXIT_CODE -ne 0 ]; then
            echo "=========================================="
            echo "ERROR: Test failed for $NNODES nodes, K=$IN_DEGREE"
        ...
        echo "Completed: $NNODES nodes, K=$IN_DEGREE"
        echo ""
    done
