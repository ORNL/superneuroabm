"""
Copied LIF Neuron step function, needs to be updated to use the new STDP step function
...
def exp_stdp_all_to_all(
    ...
    post_trace = post_trace * (1 - dt / tau_post_stdp) + post_soma_spike * aplus_exp_post
