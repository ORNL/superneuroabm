...
def lif_soma_step_func(  # NOTE: update the name to soma_step_func from neuron_step_func
    ...
    # internal_states_buffer[agent_index][t_current][3] = synapse_ids[1]  # Store synaptic id
    # internal_states_buffer[agent_index][t_current][3] = internal_state[2][0]  # internal state read from synapse 0
    # internal_states_buffer[agent_index][t_current][3] = len(agent_ids)  # Store synaptic current
